<div class="page_style">
    <span class="total">Total ${chromosomePagination.totalPages} Pages</span>
<#if chromosomePagination.firstPage>
...
<#else>
    ...
    <a href="${base}/${pageLink}${pageSuffix}<@s.property value='chromosomePagination.prevPage' />&pageSize=<@s.property value='pageSize' />&orderBy=${orderBy}&orderByType=${orderByType}"> <img src="${base}/images/prev.png" class="page_style_img" /> Prev </a>
</#if>
<#if chromosomePagination.pageNo-5 gt 1>
    <#if chromosomePagination.totalPages gt chromosomePagination.pageNo+4>
        <#list chromosomePagination.pageNo-5..chromosomePagination.pageNo+4 as i>
            <#if i == chromosomePagination.pageNo>
    ...
    <#else>
        <#list genePagination.totalPages-9..chromosomePagination.totalPages as i>
