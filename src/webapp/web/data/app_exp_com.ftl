...
<div class="main_container">
    ...
    <@s.if test="%{successActMsg != null}">
        ...
        <div class="data_outer_div">
            ...
            <br/>
            <div class="each_field_row">
             * To register the metadata associated with this experiment with the Research Data Australia website, please press 'Public Registration' button,
            </div>
            <br/>
            <div class="blank_separator"></div>
        </div>
        <@s.form action="showMdReg.jspx" namespace="/data" method="post">
        <@s.hidden name="experiment.id" />
        <@s.hidden name="fromMyExp" />
        <div class="data_header_div">
            <@s.submit value="Public Registration" cssClass="input_button2" id="wait_modal" name='wait_modal' />
