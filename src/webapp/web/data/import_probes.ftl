...
<head>
    <title><@s.text name="probe.import.action.title" /></title>
    ...
    <@s.form action="importProbes.jspx" namespace="/data" method="post" enctype="multipart/form-data" >
        <div class="data_outer_div">
            ...
            <table class="reporter_tab">
                ...
                <tr>
                    <td><@s.checkbox name="sendMailRequired" /> Required an email notification after the probes importing finished</td>
                </tr>
            </table>
            <div class="blank_separator"></div>
            <div style="clear:both"></div>
        ...
        <div class="data_outer_noborder_div">
            ...
            <div id='mask'></div>
            <div id='modal_window' >
                Importing the probes, please wait ... <img src="${base}/images/wait_loader.gif" class="loading_image">
            </div>
        </div>
    </@s.form>
