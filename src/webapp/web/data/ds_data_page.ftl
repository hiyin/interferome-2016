<@s.if test="%{dataPagination != null}">
    <div class="data_header_div">
        ...
        <div class="msg_content">
            <a href="${base}/${pageLink}${pageSuffix}${dataPagination.pageNo}&experiment.id=${experiment.id}&dataset.id=${dataset.id}&fromMyExp=<@s.property value='fromMyExp' />" class="page_url"></a>
        </div>
